...
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠈⠉⠉⠉⠉⠉⠉⠛⠛⠛⠛⠛⠛⠋⠉⠉⠉⠉⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
			...
			sections = {
				{ section = "header" },
				{ pane = 2, section = "terminal", cmd = "fortune -s", ttl = 0, height = 3, padding = 1 },
				{ pane = 2, icon = " ", title = "Actions\n", section = "keys", gap = 1, indent = 2, padding = 1 },
				{
					pane = 2,
					icon = " ",
					title = "Git Status",
	...
	keys = {
		{
			"<leader>bc",
			"<cmd>lua require('snacks').bufdelete.delete()<cr>",
			mode = "n",
			desc = "Close buffer",
			silent = true,
		},
		...
		{
			"<leader>tZ",
			"<cmd>lua require('snacks').toggle.zen()<cr>",
			mode = "n",
		...
		{
			"<leader>tz",
			"<cmd>lua require('snacks').toggle.zoom()<cr>",
			mode = "n",
			desc = "Toggle zoom on buffer",
			silent = true,
		},
		{
			"<leader>td",
			"<cmd>lua require('snacks').toggle.dim()<cr>",
			mode = "n",
			desc = "Toggle dim",
			silent = true,
		},
		...
		{
			"<leader>fh",
			"<cmd>lua require('snacks').picker.help()<cr>",
			mode = "n",
		...
		{
			"<leader>fm",
			"<cmd>lua require('snacks').picker.man()<cr>",
			mode = "n",
		...
		{
			"<leader>fl",
			"<cmd>lua require('snacks').picker.git_log()<cr>",
			mode = "n",
		...
		{
			"<leader>fb",
			"<cmd>lua require('snacks').picker.git_brances()<cr>",
			mode = "n",
		...
		{
			"<leader>b/",
			"<cmd>lua require('snacks').picker.grep_buffers()<cr>",
			mode = "n",
		...
		{
			"gD",
			"<cmd>lua require('snacks').picker.lsp_declarations()<cr>",
			mode = "n",
		...
		{
			"<leader>xD",
			"<cmd>lua require('snacks').picker.buffer_diagnostics()<CR>",
			mode = "n",
			desc = "Explore workspace diagnostics",
			silent = true,
		},
		{
			"<leader>xq",
			"<cmd>lua require('snacks').picker.qflist()<CR>",
			mode = "n",
			desc = "Explore quickfixlist",
			silent = true,
		},
		{
			"<leader>e",
